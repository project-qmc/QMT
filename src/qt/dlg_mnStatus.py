...
class Ui_MnStatusDlg(object):
    def setupUi(self, MnStatusDlg):
        ...
        body.addRow(QLabel("<b>Tx Hash: idx</b>"),
                    QLabel(self.statusData['txhash'] + ": " + str(self.statusData['outidx'])))
        ...
        body.addRow(QLabel("<b>Last Seen</b>"),
                    QLabel(time.strftime('%Y-%m-%d %H:%M:%S', time.gmtime(self.statusData['lastseen']))))
        body.addRow(QLabel("<b>Last Paid</b>"),
                    QLabel(time.strftime('%Y-%m-%d %H:%M:%S', time.gmtime(self.statusData['lastpaid']))))
