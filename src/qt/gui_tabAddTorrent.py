...
class TabAddTorrent_gui(QWidget):
    def __init__(self, caller):
        ...
        self.torrentWarningLabel = QLabel("""Submission requires 6 confirmations to process.\nDo not close the tool until 6 blocks pass since your last submission !\n\nAlso be aware that this function is in beta stage,\n1 known issue is submitting multiple magnets fast.\nTry to only submit multiple at the same number of cores your device has and waiting for 6 blocks.""")
